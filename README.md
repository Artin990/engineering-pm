# سامانه مدیریت مهندسی و هوش پروژه RadarCheck (رادار چک)

پلتفرم مدرن مدیریت پروژه‌های مهندسی و هوش تیمی: **مدیریت پروژه + مدیریت مهندسی + هوش گیت‌هاب + آنالیتیکس فردی**.
مبتنی بر Supabase Postgres، Next.js، احراز هویت RLS، و طراحی اختصاصی RTL با فونت Peyda.

> 📖 **راهنمای جامع فارسی مفاهیم پروژه (رودمپ، مایلستون‌ها، سایکل‌ها، گیت‌هاب و نقش‌ها):** [CONCEPTS_AND_GUIDE_FA.md](./CONCEPTS_AND_GUIDE_FA.md)
