...
DO $$ 
BEGIN 
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can view relevant project invitations') THEN 
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Project leads can manage project invitations') THEN 
