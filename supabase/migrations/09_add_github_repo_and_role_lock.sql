...
BEGIN
  ...
  IF v_workspace_id IS NOT NULL THEN
    -- افزودن کاربر به ورک‌اسپیس (ادمین‌ها در نقش admin/owner و سایرین در نقش member)
...
-- اعمال روی کاربران فعلی در دیتابیس
DO $$
DECLARE
  r RECORD;
BEGIN
  FOR r IN SELECT * FROM auth.users LOOP
    PERFORM public.handle_new_user_registration();
  END LOOP;
END $$;
